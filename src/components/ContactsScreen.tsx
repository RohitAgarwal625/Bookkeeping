...
export function ContactsScreen({
  ...
  return (
    <div className={`size-full flex flex-col ${isGuest ? "bg-background" : "bg-gradient-to-b from-white to-purple-50/30 dark:from-[#0F1115] dark:to-[#0F1115]"}`}>
      {/* Header — only contains "Contacts" title + separator */}
      <header className={`${isGuest ? "bg-background border-b border-gray-100 dark:border-border" : "bg-white dark:bg-card shadow-sm border-b border-gray-200 dark:border-border"} px-6 py-4 z-10 relative`}>
      ...
      <div className={`${isGuest ? "bg-background" : "bg-white dark:bg-card"} px-6 pb-3 pt-3`}>
