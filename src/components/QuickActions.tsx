            ...
            <div className="pointer-events-auto bg-white dark:bg-card rounded-2xl shadow-2xl dark:border dark:border-border w-full max-w-xs overflow-hidden">
              ...
              <div className="px-5 pb-6 flex flex-col gap-3">
                ...
                >
                  ...
                  <span style={{ fontSize: "10px" }} className="ml-auto font-normal text-amber-500 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/30 px-2.5 py-0.5 rounded-full border border-amber-200 dark:border-amber-800/40 whitespace-nowrap">
                    Coming Soon
                  </span>
                </button>
              </div>
              ...
              <div className="px-5 pb-6 flex flex-col gap-3">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-white dark:bg-card border border-transparent dark:border-border flex items-center justify-center hover:bg-gray-50 dark:hover:bg-secondary transition-colors"
                    aria-label="Manual info"
                  >
                    <Info className="w-3.5 h-3.5 text-gray-700 dark:text-muted-foreground" />
                  </button>
                  {manualTooltip && (
